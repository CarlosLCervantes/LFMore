<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<RaidCalendar>" %>
...
<table id="eventCalendar" cellpadding="0" cellspacing="0">
    <thead>
        <tr>
            <th><%= Html.ActionLink("<<Prev", "DisplayMonth", new { monthNum = (Model.MonthNumber - 1) }) %></th>
            <th colspan="5"><%= Model.MonthName %></th>
            <th><%= Html.ActionLink("Next>>", "DisplayMonth", new { monthNum = (Model.MonthNumber + 1) }) %></th>
        </tr>
        <tr>
            <th>Sunday </th>
            <th>Monday </th>
